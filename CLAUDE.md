...
**Stack:** Next.js 16 (App Router) · Supabase (Postgres + PostGIS + Auth + Storage) · Mapbox GL JS v3.20 · deck.gl v9.2 · Claude API via Vercel AI SDK · TypeScript · Tailwind CSS v4 · shadcn/ui · npm scripts / pnpm audit compatibility · Vercel
