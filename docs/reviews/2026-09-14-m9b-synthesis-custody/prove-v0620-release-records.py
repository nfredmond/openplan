"""Exercise the v0.62.0 release ledger with a surviving control and targeted faults."""
...
private=Path('/home/nathaniel/.local/state/openplan/response-write-probe-20260913')/('v0620-release-records-'+str(time.time_ns()));private.mkdir(mode=0o700)
results=[]
cases=[('baseline',None,None,None,None),('harmless-comment',ledger,'const RELEASES:','// Harmless release control.\nconst RELEASES:',None),('wrong-migration-count',ledger,'    tag: "0.62.0",\n    lastMigration: "20261014000027_engagement_synthesis_reviews.sql",\n    migrationsAtRelease: 346,\n  },','    tag: "0.62.0",\n    lastMigration: "20261014000027_engagement_synthesis_reviews.sql",\n    migrationsAtRelease: 345,\n  },','no migration has been inserted at or below a shipped high-water mark'),('missing-last-migration',ledger,'    tag: "0.62.0",\n    lastMigration: "20261014000027_engagement_synthesis_reviews.sql",\n    migrationsAtRelease: 346,\n  },','    tag: "0.62.0",\n    lastMigration: "20261014000027_missing_history.sql",\n    migrationsAtRelease: 346,\n  },',"every release's recorded last migration exists on disk"),('missing-release-section',changelog,'## 0.62.0 —','## SYNTHETIC-absent —',None)]
try:
