...
private=Path('/home/nathaniel/.local/state/openplan/response-write-probe-20260913/translation-scope-release-record-mutations');private.mkdir(mode=0o700,exist_ok=True)
results=[]
try:
 for name,source,fault in [('baseline',original,False),('harmless-comment',original+'\n// Harmless release record control.\n',False),('wrong-candidate-migration-count',original.replace('migrationsAtRelease: 327','migrationsAtRelease: 326'),True)]:
