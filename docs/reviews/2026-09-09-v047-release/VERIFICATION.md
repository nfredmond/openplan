...
[v0.47.0](https://github.com/nfredmond/openplan/releases/tag/v0.47.0) was tagged and published on September 9 at 22:59:36 UTC from main commit `f65a27db9432c1f0a460bfe8b966a8c1446327bd`. [CI, RLS and populated upgrade receipts](release-receipt.json) independently report success on that exact commit before tagging. The remote annotated tag resolves to the same commit. The earlier untagged checkpoints above are superseded by this disposition; their failed and incomplete observations remain retained. Follow-on M2d.4 code is outside this release.
