...
STATE={'count':338,'latest':'20261014000019','command':True,'anonymousCommand':False,'directWrites':False,'tableAcl':'synthetic-table-acl','commandAcl':'synthetic-function-acl'}
...
class WrapperTests(unittest.TestCase):
    ...
    def test_child_cannot_silently_change_installed_state(self):
        for key,value in [('command',False),('tableAcl','changed-table-acl'),('commandAcl','changed-function-acl'),('latest','20261014000020')]:
