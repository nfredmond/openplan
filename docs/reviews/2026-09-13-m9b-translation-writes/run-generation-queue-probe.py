...
result={'passed':passed,'rollbackContained':True,'container':container,'sourceSha256':hashlib.sha256(source.encode()).hexdigest(),'probeSha256':hashlib.sha256(probe.encode()).hexdigest()}
