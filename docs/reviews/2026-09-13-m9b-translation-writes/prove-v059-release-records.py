"""Exercise the v0.59 release ledger with a surviving control and targeted faults."""
...
private=Path('/home/nathaniel/.local/state/openplan/response-write-probe-20260913')/('v059-release-records-'+str(time.time_ns()));private.mkdir(mode=0o700)
results=[]
cases=[('baseline',None,None,None,None),('harmless-comment',ledger,'const RELEASES:','// Harmless release control.\nconst RELEASES:',None),('wrong-migration-count',ledger,'migrationsAtRelease: 339','migrationsAtRelease: 338','no migration has been inserted at or below a shipped high-water mark'),('missing-last-migration',ledger,'20261014000020_engagement_public_translation_queue.sql','20261014000020_missing_translation_queue.sql',"every release's recorded last migration exists on disk"),('missing-operator-migration',changelog,'20261014000020_engagement_public_translation_queue.sql','SYNTHETIC_missing_migration.sql',None)]
try:
