...
try:
    ...
    (base / f'translation-editor-cleanup-{"access-" if os.environ.get("OPENPLAN_TRANSLATION_ACCESS_PROBE") == "1" else ""}{suffix}.json').write_text(json.dumps({'childExit': code, 'grantRevoked': revoked}))
