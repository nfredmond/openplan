...
See [OWP research](OWP_ADMINISTRATION_REQUIREMENTS_RESEARCH.md), CORE-OWP-01 and M2d.1–4 for source limits, complete-cycle verification and unresolved current-form/amendment wording. Rules and forms bind to actual agency/funding/version; the LAPM is not a universal OWP invoice specification. This is proposed architecture, not implemented behavior.
