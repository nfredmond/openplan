...
`NATIONAL_LOCAL_ASSISTANCE_COMPARISON.md` recommends Oregon/Washington/Nevada next, with New York/Minnesota as contrasting procedural tests and Florida/Texas following. Four reports inventory official publication families and selected reading. Full seven-manual reading is not claimed. G1a now makes full priority reading, all-state/DC source coverage and practitioner proof separate obligations.
