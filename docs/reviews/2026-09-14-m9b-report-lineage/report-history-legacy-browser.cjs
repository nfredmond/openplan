...
const prefix=dir+`/report-history-legacy-${fixed?'after':'before'}-${width}-${Date.now()}`,observed={width,fixed,completed:false,console:[],downloads:[]};
