"""Exercise the v0.61 release ledger with a surviving control and targeted faults."""
...
private=Path('/home/nathaniel/.local/state/openplan/response-write-probe-20260913')/('v061-release-records-'+str(time.time_ns()));private.mkdir(mode=0o700)
results=[]
cases=[('baseline',None,None,None,None),('harmless-comment',ledger,'const RELEASES:','// Harmless release control.\nconst RELEASES:',None),('wrong-migration-count',ledger,'migrationsAtRelease: 343','migrationsAtRelease: 342','no migration has been inserted at or below a shipped high-water mark'),('missing-last-migration',ledger,'20261014000024_engagement_report_decision_history.sql','20261014000024_missing_report_history.sql',"every release's recorded last migration exists on disk"),('missing-operator-migration',changelog,'20261014000024_engagement_report_decision_history.sql','SYNTHETIC_missing_migration.sql',None)]
try:
