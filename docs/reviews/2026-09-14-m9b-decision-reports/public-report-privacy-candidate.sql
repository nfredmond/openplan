-- Candidate only: honor explicit private metadata independently of review status.
...
GRANT EXECUTE ON FUNCTION public.engagement_item_public_copy_allowed(text,jsonb) TO service_role;
