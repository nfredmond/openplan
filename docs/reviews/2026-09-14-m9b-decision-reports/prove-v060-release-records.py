"""Exercise the v0.60 release ledger with a surviving control and targeted faults."""
...
private=Path('/home/nathaniel/.local/state/openplan/response-write-probe-20260913')/('v060-release-records-'+str(time.time_ns()));private.mkdir(mode=0o700)
results=[]
cases=[('baseline',None,None,None,None),('harmless-comment',ledger,'const RELEASES:','// Harmless release control.\nconst RELEASES:',None),('wrong-migration-count',ledger,'migrationsAtRelease: 342','migrationsAtRelease: 341','no migration has been inserted at or below a shipped high-water mark'),('missing-last-migration',ledger,'20261014000023_engagement_public_copy_privacy.sql','20261014000023_missing_public_privacy.sql',"every release's recorded last migration exists on disk"),('missing-operator-migration',changelog,'20261014000023_engagement_public_copy_privacy.sql','SYNTHETIC_missing_migration.sql',None)]
try:
