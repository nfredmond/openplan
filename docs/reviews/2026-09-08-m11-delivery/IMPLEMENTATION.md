...
Remaining agency work: concurrent approvals; clean/populated upgrade; final role/export/worker checks; keyboard/desktop/390px and interruption journeys; complete QA, CI and release preparation. Remaining-work scheduling/forecasts, weekly PM action and settlement/closeout remain unimplemented. Preserve all four increments above.
