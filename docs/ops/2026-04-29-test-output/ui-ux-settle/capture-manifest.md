...
The NCTC seed now provides deterministic plan and program fixtures for `/plans`, `/plans/d0000001-0000-4000-8000-000000000015`, `/programs`, and `/programs/d0000001-0000-4000-8000-000000000016`. The seed does not currently provide deterministic report, model-detail, or scenario-set detail IDs. Those routes still need a local populated fixture before final capture. If the fixture is missing during the proof pass, record the missing dependency instead of substituting an empty-state screenshot.
