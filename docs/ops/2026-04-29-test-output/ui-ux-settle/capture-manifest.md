...
| Data Hub connector | `d0000001-0000-4000-8000-000000000050` | `NCTC RTP evidence catalog` |
| Data Hub equity dataset | `d0000001-0000-4000-8000-000000000051` | `Nevada County ACS equity tract context` |
| Data Hub corridor dataset | `d0000001-0000-4000-8000-000000000052` | `SR-49 safety package corridor screening` |
| Data Hub crash/comment dataset | `d0000001-0000-4000-8000-000000000053` | `SR-49 and Grass Valley safety comment/crash points` |
...
| Data Hub | `data-hub` | `/data-hub` | NCTC Data Hub connector and datasets visible: `NCTC RTP evidence catalog`, `Nevada County ACS equity tract context`, `SR-49 safety package corridor screening`, and `SR-49 and Grass Valley safety comment/crash points`. Rerun the local NCTC seed before capture if these records are not present. | Desktop and mobile data hub worksurface. | Capture tablet if data registry and map preview split. |
...
| `data-hub--desktop--workspace-data.png` | `/data-hub` | 1440x1100 | NCTC demo workspace | NCTC Data Hub connector and datasets visible | Data hub worksurface | None after 2026-05-01 local seed recapture | Captured |
