...
- `fixture-auth-continuation.md` - practical local-only runbook for closing the remaining scenario/grants recaptures and blocked/detail/admin authorization-check gaps.
...
- Grants: seed-backed by `openplan/scripts/seed-nctc-demo.ts` with opportunity `d0000001-0000-4000-8000-000000000018`, awarded opportunity `d0000001-0000-4000-8000-000000000041`, award `d0000001-0000-4000-8000-000000000042`, and invoice `d0000001-0000-4000-8000-000000000043`; desktop/mobile recapture pending.

## Proof Pack Rule

Screenshots should show the actual usable worksurface in populated state. Do not accept captures that show only a loading shell, empty placeholder, marketing page, redirect screen, or cropped hero. Remaining unsettled rows are scenario and grants recapture.
