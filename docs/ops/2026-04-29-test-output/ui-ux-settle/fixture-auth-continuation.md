...
- Current remaining proof-pack gaps are:
  - plan recapture pending: `/plans`, `/plans/d0000001-0000-4000-8000-000000000015` at desktop and mobile after the updated local NCTC seed runs.
  - `fixture_required`: `/programs`, `/programs/<local-program-id>`, `/reports`, `/reports/<local-report-id>`, `/scenarios`, `/scenarios/<local-scenario-set-id>`, `/grants` at desktop and mobile.
