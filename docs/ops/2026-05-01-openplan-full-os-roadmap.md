...
- `2026-05-01-openplan-production-admin-operations-authenticated-smoke.md` proves the production admin operations surface loads for the configured reviewer with service-lane intake unlocked and no triage/provision actions taken.
