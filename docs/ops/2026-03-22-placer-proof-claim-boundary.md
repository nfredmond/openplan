...
> **DATED RECORD — 2026-03-22.** This describes what was true on the day it was written.
...
## Known mismatch to correct before broader reuse
The current `run_output/evidence_packet.json` still reports:
- `network_source: "OpenStreetMap"`

But the current Placer package manifest is based on:
- `TIGER/Line 2023 Roads (tl_2023_06061_roads)`

This wording mismatch does **not** invalidate the proof-of-runnability claim, but it should be corrected before any wider internal circulation or preservation commit that uses the evidence packet as a canonical proof descriptor.
