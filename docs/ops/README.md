...
| [2026-05-17 buyer-demo preflight proof](../../openplan/docs/ops/2026-05-17-buyer-demo-preflight-proof.md) | **Current buyer-demo operator preflight** — `npm run ops:check-buyer-demo-preflight` bundles sales claim-boundary checks with local-first pilot preflight; live health/Vercel reads require explicit `--live-reads` opt-in |
...
| [2026-05-10 pilot preflight operator proof](2026-05-10-openplan-pilot-preflight-operator-proof.md) | **Current operator pre-conversation proof** — `npm run ops:check-pilot-preflight` usage, sample output, and read-only/no-write/no-secret safety boundary |
...
| [2026-05-10 prod health evidence-log helper](2026-05-10-prod-health-evidence-log-helper.md) | **Post-main-push production evidence helper** — canonical command `npm run ops:log-prod-health-evidence -- --vercel-inspect-json /tmp/openplan-vercel-inspect.json --require-vercel-ready`; generated artifact path `docs/ops/YYYY-MM-DD-test-output/prod-health-evidence/YYYYMMDDTHHMMSSZ-prod-health-evidence.md`; pairs Vercel Ready state with the public health check in a local no-secrets/no-Supabase evidence log |
| [2026-05-10 admin ops to prod-health evidence bridge](2026-05-10-openplan-admin-ops-to-prod-health-evidence-bridge.md) | **Post-deploy admin proof bridge** — keeps Admin Operations no-write proof adjacent to Vercel Ready + public health evidence logging after deploys |
...
- [2026-05-17 buyer-demo preflight proof](../../openplan/docs/ops/2026-05-17-buyer-demo-preflight-proof.md) — current no-approval buyer-demo preflight command; bundles claim-boundary checks with local-first pilot preflight and requires `--live-reads` for production health/Vercel reads
...
- [2026-05-10 pilot preflight operator proof](2026-05-10-openplan-pilot-preflight-operator-proof.md) — current `npm run ops:check-pilot-preflight` operator proof with sample output, buyer/demo/pilot timing, and explicit read-only/no-production-write/no-schema-apply/no-secret-exposure boundary
- [2026-05-10 prod health evidence-log helper](2026-05-10-prod-health-evidence-log-helper.md) — post-main-push helper using canonical command `npm run ops:log-prod-health-evidence -- --vercel-inspect-json /tmp/openplan-vercel-inspect.json --require-vercel-ready` and generated artifact path `docs/ops/YYYY-MM-DD-test-output/prod-health-evidence/YYYYMMDDTHHMMSSZ-prod-health-evidence.md`; records Vercel Ready state and `ops:check-prod-health` output together without secrets, Supabase access, or production writes
...
- [2026-05-10 prod health evidence-log helper](2026-05-10-prod-health-evidence-log-helper.md) — operator helper for logging the post-main-push production health evidence gate once Vercel is Ready; canonical command `npm run ops:log-prod-health-evidence -- --vercel-inspect-json /tmp/openplan-vercel-inspect.json --require-vercel-ready`; generated artifact path `docs/ops/YYYY-MM-DD-test-output/prod-health-evidence/YYYYMMDDTHHMMSSZ-prod-health-evidence.md`; local file output only, no secrets, no Supabase, no production writes
- [2026-05-10 admin ops to prod-health evidence bridge](2026-05-10-openplan-admin-ops-to-prod-health-evidence-bridge.md) — post-deploy bridge requiring Vercel Ready + public health evidence to stay adjacent to the no-write Admin Operations proof flow; no prospect PII, Supabase access, secrets, or production writes
...
- [2026-05-17 buyer-demo preflight proof](../../openplan/docs/ops/2026-05-17-buyer-demo-preflight-proof.md) — current no-approval buyer-demo preflight command; default run is local-first/read-only and live production health/Vercel reads require explicit `--live-reads` opt-in
- [2026-05-10 pilot preflight operator proof](2026-05-10-openplan-pilot-preflight-operator-proof.md) — current read-only pilot preflight bundle proof for local Supabase guard, migration inventory, production health, and Vercel deployment readiness checks before supervised buyer/demo/pilot conversations
- [2026-05-10 Wave 6 release-readiness summary](2026-05-10-openplan-wave6-release-readiness-summary.md) — concise operator summary of the May 10 proof/readiness merge train, validation posture, caveats, and merge risk; pair with the pilot preflight proof before buyer reliance
