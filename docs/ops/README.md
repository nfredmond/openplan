...
| [2026-05-01 local Phase 1 spine smoke](2026-05-01-openplan-local-spine-smoke.md) | **Current shared-spine proof** — one seeded NCTC project reused across RTP, grants, engagement, analysis/county-run, reports, map, Data Hub, and aerial evidence; harness cleanup now removes prior spine-smoke reports before rerun |
| [2026-05-01 local Aerial evidence smoke](2026-05-01-openplan-local-aerial-evidence-smoke.md) | **Current local Aerial evidence spine proof** — project-linked mission, AOI PATCH, ready package, exact seeded-plus-new posture counts, Aerial surfaces, and map AOI feature without a duplicate project |
...
- [2026-05-01 local Phase 1 spine smoke](2026-05-01-openplan-local-spine-smoke.md) — shared-spine proof that one NCTC project ID is reused across RTP, grants, engagement, analysis/county-run, report, map, Data Hub, and aerial evidence rows; harness cleanup now removes prior spine-smoke reports and dependent rows before rerun
- [2026-05-01 local Aerial evidence smoke](2026-05-01-openplan-local-aerial-evidence-smoke.md) — local Aerial evidence spine proof for mission creation, AOI PATCH, ready package creation, exact seeded-plus-new aerial posture counts, Aerial list/detail rendering, and map AOI feature without a duplicate project
