...
| [2026-05-10 prod health evidence-log helper](2026-05-10-prod-health-evidence-log-helper.md) | **Post-main-push production evidence helper** — pairs Vercel Ready state with the public health check in a local no-secrets/no-Supabase evidence log |
...
- [2026-05-10 prod health evidence-log helper](2026-05-10-prod-health-evidence-log-helper.md) — post-main-push helper that records Vercel Ready state and `ops:check-prod-health` output together without secrets, Supabase access, or production writes
