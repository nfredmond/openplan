...
| Request-access intake and owner/teammate invitation have proof, and onboarding remains supervised. | [workspace provisioning invite flow](../../openplan/docs/ops/2026-04-24-workspace-provisioning-invite-flow-proof.md); [request-access workspace invite handoff](../../openplan/docs/ops/2026-04-24-request-access-workspace-invite-handoff-proof.md) | The proof shows request-access intake and invitation posture; it is not automatic public self-serve workspace activation. | Confirm the buyer owner, access roles, data sensitivity posture, first workflow, and whether manual or automated invites are authorized. |
