...
| Travel demand, corridor, scenario, and performance analysis | Partial | AequilibraE, ActivitySim, common assignment, agreement map, rules-v4 same-basis observed-count assessment and immutable custody | Untouched use-specific California and nationwide acceptance evidence; demand distribution, network and external-trip defects |
...
## Organization coverage at v0.38.1
