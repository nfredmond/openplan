...
| Travel demand, corridor, scenario, and performance analysis | Partial | AequilibraE, ActivitySim, common assignment, agreement map, rules-v4 same-basis observed-count assessment, frozen structural diagnosis, and immutable custody | New comparable observation/match instrument; untouched use-specific California and nationwide acceptance evidence; demand distribution, network and external-trip defects |
...
## Organization coverage at v0.40.0
