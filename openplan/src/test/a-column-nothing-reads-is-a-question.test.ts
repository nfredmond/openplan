...
const UNREAD_COLUMNS: ReadonlyArray<{
  ...
  { column: "engagement_content_translations.response_target_id", category: "READ_IN_SQL", reason: "Generated from the polymorphic translation address and consumed by the campaign-scoped response foreign key. It prevents direct writes and concurrent source moves from crossing campaign boundaries; application code uses the original address." },
  ...
  ...[
    ...
    "project_portfolio_import_rows.worksheet_name",
  ].map((column) => ({
    column,
