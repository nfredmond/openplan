...
describe('retained receipt and edited draft have separate meaning',()=>{
 ...
 it('restores optional participant details and keeps an existing receipt accessible after closing',async()=>{
  localStorage.setItem('openplan-engagement-draft:retry-photo-test:new',JSON.stringify({version:1,body:'Original',geometry:{type:'LineString',coordinates:[[1,2],[1,2]]},requestId:'11111111-1111-4111-8111-111111111111',ageBand:'35_44',zip5:'95945',primaryLanguage:'en',raceEthnicity:['white'],householdTenure:'rent',receipt:{submissionId:'saved-id',receivedAt:'2026-09-01'}}));
