...
const action={kind:"record_stage_gate_hold",workspaceId,projectId,gateId:"G01_INITIATION_AUTHORIZATION",rationale:"Synthetic missing evidence"};
...
beforeEach(()=>{vi.clearAllMocks();fixture.rows.workspace_members={workspace_id:workspaceId,role:"owner"};fixture.rows.projects={id:projectId,workspace_id:workspaceId};fixture.rows.workspaces={id:workspaceId,stage_gate_template_id:"ca_stage_gates_v0_1",stage_gate_template_selection:"explicitly_requested",home_geography_source:null,home_geography_kind:null,home_geography_ref:null,home_country_code:null,home_subdivision_code:null};fixture.rows.stage_gate_decisions=null;});
describe("HOLD consent captures current context",()=>{
