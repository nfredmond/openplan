...
const DEDICATED_LIVE_RLS_PROBES = new Set([
  ...
  "program_work_program_workflow",
  "program_work_program_events",
  "program_work_program_reviews",
  "program_work_program_packets",
  "contract_order_periods",
  "contract_management_responses",
  "contract_response_applications",
  "contract_settlement_events",
  "contract_deliverable_events",
  "contract_closeouts",
  "contract_calculation_jobs",
  "contract_source_changes",
  "contract_schedules",
  "contract_capacity_versions",
  "contract_work_updates",
  "contract_forecasts",
  "contract_master_terms",
  "contract_access_versions",
  "contract_received_invoices",
  "contract_received_files",
  "contract_accounting_imports",
  "contract_accounting_reviews",
  "contract_baselines",
  "contract_rates",
  "contract_actual_versions",
  "contract_estimates",
  "contract_snapshots",
  "contract_billing_sources",
  "contract_imports",
  "contract_source_deletions",
  "contract_tasks",
  "contract_task_assignments",
  "work_program_actual_versions",
  "work_program_cost_rates",
  "work_program_period_reports",
  "work_program_reporting_periods",
  "work_program_reimbursement_claims",
  "work_program_reimbursement_sources",
  "work_program_reimbursement_events",
  "work_program_closeout_records",
  "work_program_period_closures",
