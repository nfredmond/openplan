...
describe("documented invoice summary",()=>{
 ...
 it("ages the amount currently due, separates held cash and refuses a changed invoice version",async()=>{
  const row={id:"1",engagement_id:"synthetic",client_id:"client",due_date:"2026-08-01",updated_at:"2026-09-08T00:00:00.000001+00:00"};mocks.range.mockResolvedValue({data:[row],error:null});
