...
-- Identify this receipt: a deliberate broad-read fault may expose older retained fixtures.
SELECT pg_temp.assert_true((SELECT count(*)=1 FROM engagement_decision_request_resolutions WHERE id='72ac9585-42e6-4eab-a253-fc3a57cd9518'),'Installed original requester cannot read recovery copies');
...
SELECT pg_temp.assert_true((SELECT count(*)=2 FROM engagement_decision_request_resolutions WHERE id IN ('72ac9585-42e6-4eab-a253-fc3a57cd9518','a0b05230-98f4-49d1-9857-42f7d39e57a2')),'Second original copy was lost');
