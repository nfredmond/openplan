...
const RELEASES: ReadonlyArray<{ tag: string; lastMigration: string; migrationsAtRelease: number }> = [
  ...
  {
    tag: "0.45.0",
    lastMigration: "20260910000003_work_program_report_exports.sql",
    migrationsAtRelease: 271,
  },
  {
    tag: "0.46.0",
    lastMigration: "20260911000008_contract_source_deletions.sql",
    migrationsAtRelease: 279,
  },
  {
    tag: "0.47.0",
    lastMigration: "20261003000001_work_program_reimbursement.sql",
    migrationsAtRelease: 307,
  },
  {
    tag: "0.48.0",
  ...
  {
    tag: "0.54.0",
    lastMigration: "20261011000002_assistant_opencode_connections.sql",
    migrationsAtRelease: 316,
  },
  {
    tag: "0.55.0",
  ...
  {
    tag: "0.57.0",
    lastMigration: "20261014000007_engagement_conflicts_without_transaction_retry.sql",
    migrationsAtRelease: 326,
  },
  {
    tag: "0.57.1",
    lastMigration: "20261014000008_engagement_translation_scope.sql",
    migrationsAtRelease: 327,
  },
  {
    tag: "0.58.0",
  ...
  {
    tag: "0.59.0",
    lastMigration: "20261014000020_engagement_public_translation_queue.sql",
    migrationsAtRelease: 339,
  },
  {
    tag: "0.60.0",
    lastMigration: "20261014000023_engagement_public_copy_privacy.sql",
