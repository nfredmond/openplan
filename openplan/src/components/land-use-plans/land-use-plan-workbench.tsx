...
export function LandUsePlanWorkbench({ planId }: { planId: string }) {
  ...
  const latestClosedRelease = currentVersionReleases.find((release) => release.status === "closed");
