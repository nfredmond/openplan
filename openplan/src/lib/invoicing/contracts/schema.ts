...
export type BaselineVersion = { id: string; version: number; state: "proposed" | "approved"; content: ContractBaseline; content_hash: string; approval_evidence: string; created_at: string; approved_at: string | null };
