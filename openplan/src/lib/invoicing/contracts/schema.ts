...
export type MasterTerms = {id:string; version:number; state:"proposed"|"approved"; currency:string; ceiling:string; starts_on:string; ends_on:string; terms:string; approval_evidence:string; source_document_id:string};
