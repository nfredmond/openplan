...
export async function loadCampaignAccess(
  ...
  const { data: campaign, error: campaignError } = (await client
    ...
    .select("id, workspace_id, project_id, rtp_cycle_id, rtp_cycle_chapter_id, title, summary, status, engagement_type, participation_starts_at, participation_ends_at, configuration_version_id, share_token, public_description, allow_public_submissions, submissions_closed_at, created_at, updated_at")
    .eq("id", campaignId)
