...
const accessPoints = [
  "Create the right identity before project setup begins.",
  "Keep workspace targeting explicit so access and support records stay aligned.",
          ...
          <aside className="flex flex-col justify-between gap-8 border-b border-border/60 pb-8 lg:border-b-0 lg:border-r lg:pb-0 lg:pr-10">
            <div className="space-y-5">
              <div className="space-y-2">
                ...
                <p className="max-w-2xl text-sm leading-6 text-muted-foreground sm:text-base">
                  OpenPlan treats sign-in and account creation as supervised workspace identity steps. This lane keeps the record clean so the right team, workspace, and support context stay attached to each other.
                </p>
              </div>
            ...
            <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-1 xl:grid-cols-2">
              <div className="border-l-2 border-[color:var(--pine)] bg-[color:var(--pine)]/6 px-4 py-3">
                ...
                <p className="mt-2 text-sm text-foreground">Create the account first, then enter the app and confirm the actual workspace before delivery work begins.</p>
              </div>
              <div className="border-l-2 border-[color:var(--copper)] bg-[color:var(--copper)]/10 px-4 py-3">
                ...
                <p className="mt-2 text-sm text-foreground">This removes the ambiguity where access, payment records, or service work could point at the wrong workspace context.</p>
              </div>
            </div>
          </aside>
