  ...
  const actions = [
    {
      ...
      description: "Run the existing corridor intelligence workflow inside the new Planning OS shell.",
    },
    {
      href: "/projects",
      title: "Open Projects Module",
      description: "See the new module lane for project records, deliverables, risks, and decisions.",
    },
    {
      href: "/reports",
      title: "Open Reports Surface",
      description: "Review where binder exports, board packets, and grant-ready outputs will converge.",
    },
  ];
    ...
    <section className="space-y-6">
      <header className="space-y-2.5">
        ...
        <p className="text-sm text-muted-foreground sm:text-base">
          Signed in as {user?.email}. The shell reset is now live: OpenPlan is being restructured into a Planning OS with Analysis Studio as one module inside it.
        </p>
