...
import { Clock3, Database, Radar } from "lucide-react";
...
type ProjectEvidenceAndActivityProps = {
  ...
  /**
   * ACCEPTED AND IGNORED. The activity feed moved to `ProjectActivityTimeline`
   * so it sits with the record it summarises. Declared only, so callers written
   * against the old shape still type-check while they are updated.
   */
