...
export default function EngagementError({
  ...
  return (
    <div className="px-6 py-8">
      <StateBlock
        tone="danger"
        title="The engagement surface hit an error."
        description={
          error.digest
            ? `Reference ${error.digest}. Try again, or return to the engagement campaigns list.`
            : "Try again, or return to the engagement campaigns list."
        }
        action={
