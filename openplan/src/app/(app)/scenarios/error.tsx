...
export default function ScenariosError({
  ...
  useEffect(() => {
    console.error("[openplan/scenarios-error]", {
  ...
  return (
    <div className="px-6 py-8">
      <ErrorState
        title="Something went wrong in Scenarios."
        description={
          error.digest
            ? `Reference ${error.digest}. Nothing has been deleted — this screen failed to load. Try again, or go back to Scenarios.`
            : "Nothing has been deleted — this screen failed to load. Try again, or go back to Scenarios."
        }
        action={
