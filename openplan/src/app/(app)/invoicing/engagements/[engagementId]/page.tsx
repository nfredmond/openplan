...
export default async function ContractPage({params}:{params:Promise<{engagementId:string}>}) {
 ...
 if(access.response)return <main className="p-8"><h1 className="text-2xl">Contract management unavailable</h1><p className="mt-3">Sign in with access to this contract workspace, and confirm the contract is linked to a project.</p></main>;
