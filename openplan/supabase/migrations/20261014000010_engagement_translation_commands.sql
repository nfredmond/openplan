-- Exact-source translation commands and retained write receipts.
-- Execute remains revoked until all producers and generation publication are
-- joined by the following workflow migration. This increment is unreleased.
