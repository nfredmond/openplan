...
NEVADA_COUNTY_FIPS = "06057"

# ── 1. Load and filter roads ──────────────────────────────────────────────
print("Loading Nevada County roads...")
roads = gpd.read_file(os.path.join(DATA_DIR, "roads", "tl_2023_06057_roads.shp"))
...
nev_tracts = tracts[tracts["COUNTYFP"] == "057"].copy()
print(f"  Nevada County tracts: {len(nev_tracts)}")
...
manifest = {
    "package_name": "nevada-county-accessibility-v1",
    "version": "1.0.0-draft",
    "geography": {
    ...
    "network": {
        "source": "TIGER/Line 2023 Roads (tl_2023_06057_roads)",
...
# ── Summary ──────────────────────────────────────────────────────────────
print("\n" + "=" * 60)
print("NEVADA COUNTY PILOT NETWORK PACKAGE — BUILD COMPLETE")
print("=" * 60)
