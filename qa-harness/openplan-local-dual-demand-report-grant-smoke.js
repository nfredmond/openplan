...
async function main() {
  ...
  try {
    ...
    await page.getByText('Generated artifacts', { exact: true }).waitFor({ timeout: 30000 });
    evidence.observations.push('Generated the report packet through the visible report controls.');
    await screenshotLocator(
      page.getByText('Generated artifacts', { exact: true }).locator('xpath=ancestor::article[1]'),
